...
function scene:create( event )
	...
	Cookie1 	= Cookie.newCookie( 160,200,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 160,180 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 160,260 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 40,140 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
    ...
    local ropeAuto1 	= RopeAuto.newRopeAuto( {extraLength=80,	nubX=120,	nubY=20,	body=Cookie1,	perimeter=70,	density=120} )
    local Bubble1 	= Bubble.newBubble(160,260)
