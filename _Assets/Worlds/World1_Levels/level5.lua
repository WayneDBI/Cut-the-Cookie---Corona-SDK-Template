...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=240,	positionY=445  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 80,260,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 80,300 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 240,140 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 240,60 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 	= Rope.newRope( {extraLength=0,		nubX=80,	nubY=70,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope2 	= Rope.newRope( {extraLength=0,		nubX=240,	nubY=200,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    local Spike1 	= Spike.newSpike( {spikeType=1,	x=40,	y=280,	getAngle=90,	doRotate=false,	rotateSpeed=2}	) -- spikeType (1 to 4), x, y, getAngle, doRotate, rotateSpeed
    local Bubble1 	= Bubble.newBubble(120,330)
