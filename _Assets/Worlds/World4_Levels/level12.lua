...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=90,	positionY=450  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 60,300,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 90,220 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 220,240 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 100,120 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 = Rope.newRope( {extraLength=0,		nubX=40,	nubY=360,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope2 = Rope.newRope( {extraLength=-5,	nubX=120,	nubY=180,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	
    local ropeAuto1 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=180,	nubY=300,	body=Cookie1,	perimeter=60,	density=120} )
    local ropeAuto2 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=200,	nubY=100,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto3 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=160,	nubY=40,	body=Cookie1,	perimeter=40,	density=120} )
	...
	------------------------------------------------------------------------------------------------------------------------------------
	-- Insert your BUBBLES after all other game elements: We want them to be on top
	------------------------------------------------------------------------------------------------------------------------------------
