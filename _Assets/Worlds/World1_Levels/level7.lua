...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=280,	positionY=450  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 160,160,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 160,200 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 200,380 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 60,360 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	...
	local Rope2 = Rope.newRope( {extraLength=0,	nubX=40,	nubY=100,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope3 = Rope.newRope( {extraLength=0,	nubX=285,	nubY=100,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope4 = Rope.newRope( {extraLength=0,	nubX=40,	nubY=240,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope5 = Rope.newRope( {extraLength=0,	nubX=285,	nubY=240,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    
    local ropeAuto1 = RopeAuto.newRopeAuto( {extraLength=110,	nubX=160,	nubY=280,	body=Cookie1,	perimeter=40,	density=120} )

	------------------------------------------------------------------------------------------------------------------------------------
	--Other items you could have added.
 	------------------------------------------------------------------------------------------------------------------------------------
    --local Bubble1 	= Bubble.newBubble(200,340) : x,y position
	...
	screenGroup:insert( Rope4 )
	screenGroup:insert( Rope5 )
