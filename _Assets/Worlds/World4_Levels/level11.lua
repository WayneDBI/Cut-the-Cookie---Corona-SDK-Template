...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=160,	positionY=450  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 160,160,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 40,220 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 100,340 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 200,320 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 = Rope.newRope( {extraLength=0,		nubX=160,	nubY=40,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope2 = Rope.newRope( {extraLength=20,	nubX=100,	nubY=80,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope3 = Rope.newRope( {extraLength=20,	nubX=220,	nubY=80,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	
    local ropeAuto1 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=60,	nubY=140,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto2 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=260,	nubY=140,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto3 = RopeAuto.newRopeAuto( {extraLength=80,	nubX=110,	nubY=260,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto4 = RopeAuto.newRopeAuto( {extraLength=80,	nubX=210,	nubY=260,	body=Cookie1,	perimeter=40,	density=120} )
	...
	screenGroup:insert( Rope2 )
	screenGroup:insert( Rope3 )
	screenGroup:insert( ropeAuto1 )
	screenGroup:insert( ropeAuto2 )
	screenGroup:insert( ropeAuto3 )
	screenGroup:insert( ropeAuto4 )
