...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=100,	positionY=110  }   )		-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 160,360,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 160,420 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 100,220 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 80,300 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 	= Rope.newRope( {extraLength=20,	nubX=160,	nubY=160,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope2 	= Rope.newRope( {extraLength=30,	nubX=220,	nubY=260,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope3 	= Rope.newRope( {extraLength=10,	nubX=80,	nubY=380,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    local Bubble1 	= Bubble.newBubble(160,420)
