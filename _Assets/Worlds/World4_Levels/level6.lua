...
function scene:create( event )
	...
	Cookie1 	= Cookie.newCookie( 160,190,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 160,140 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 160,310 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 160,20 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 	= Rope.newRope( {extraLength=0,	nubX=160,	nubY=60,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    local Bubble1	= Bubble.newBubble(160,270)
