...
function scene:createScene( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=260,	positionY=440  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 160,40,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 260,100 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 260,40 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 300,300 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 		= Rope.newRope( {extraLength=0,	nubX=40,	nubY=80,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    local ropeAuto1 	= RopeAuto.newRopeAuto( {extraLength=20,	nubX=280,	nubY=260,	body=Cookie1,	perimeter=40,	density=120} )
    local Bubble1 		= Bubble.newBubble(190,180)
    local Spike1 		= Spike.newSpike( {spikeType=4,	x=80,	y=360,	getAngle=0,		doRotate=true,	rotateSpeed=3}	) -- spikeType (1 to 4), x, y, getAngle, doRotate, rotateSpeed
