...
function scene:create( event )
	...
	Cookie1 	= Cookie.newCookie( 50,120,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 80,260 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 160,360 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 220,260 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	-- *******   ADD YOUR LEVEL DATA BELOW, ROPES, BUBBLES, SPIKES ETC..  **************************************************************
	-- *********************************************************************************************************************************
	-- Add ROPES, AUTO-ROPES, SPIKES and BUBBLES as required
	-- *********************************************************************************************************************************
	local Rope1 	= Rope.newRope( {extraLength=0,	nubX=50,	nubY=60,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
    local ropeAuto1 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=100,	nubY=180,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto2 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=160,	nubY=280,	body=Cookie1,	perimeter=40,	density=120} )
    local ropeAuto3 = RopeAuto.newRopeAuto( {extraLength=40,	nubX=240,	nubY=380,	body=Cookie1,	perimeter=40,	density=120} )

    local Spike1 	= Spike.newSpike( {spikeType=1,	x=220,	y=60,	getAngle=0,		doRotate=true,	rotateSpeed=2}	) -- spikeType (1 to 4), x, y, getAngle, doRotate, rotateSpeed
    local Spike2 	= Spike.newSpike( {spikeType=2,	x=280,	y=180,	getAngle=0,		doRotate=true,	rotateSpeed=-2}	) -- spikeType (1 to 4), x, y, getAngle, doRotate, rotateSpeed
	...
	screenGroup:insert( Spike1 )
	screenGroup:insert( Spike2 )
