...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=240,	positionY=420  }   )	-- Hero: Set X, Y position on the screen.
    ...
    Star3 		= Star.newStar( 20,200 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
    ...
    local ropeAuto1 	= RopeAuto.newRopeAuto( {extraLength=40,	nubX=100,	nubY=180,	body=Cookie1,	perimeter=60,	density=120} )
    local ropeAuto2 	= RopeAuto.newRopeAuto( {extraLength=70,	nubX=80,	nubY=300,	body=Cookie1,	perimeter=20,	density=120} )
    local Spike1 		= Spike.newSpike( {spikeType=4,	x=250,	y=220,	getAngle=0,		doRotate=false,	rotateSpeed=2}	) -- spikeType (1 to 4), x, y, getAngle, doRotate, rotateSpeed
