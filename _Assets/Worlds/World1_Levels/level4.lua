...
function scene:create( event )
	...
	-- *********************************************************************************************************************************
    HeroTarget	= Hero.newHero(   {  positionX=280,	positionY=380  }   )	-- Hero: Set X, Y position on the screen.
	Cookie1 	= Cookie.newCookie( 160,180,0,0 )							-- Add the Cookie: (X, Y, [Initial VelocityX, VelocityY])
    Star1 		= Star.newStar( 160,220 )									-- Add Star 1 to the scene
    Star2 		= Star.newStar( 160,440 )									-- Add Star 2 to the scene
    Star3 		= Star.newStar( 40,300 )									-- Add Star 3 to the scene
	-- *********************************************************************************************************************************
	...
	local Rope2 = Rope.newRope( {extraLength=0,		nubX=160,	nubY=320,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope3 = Rope.newRope( {extraLength=15,	nubX=40,	nubY=180,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	local Rope4 = Rope.newRope( {extraLength=15,	nubX=280,	nubY=180,	targetX=Cookie1.x,	targetY=Cookie1.y,	body=Cookie1,	density=120} )
	------------------------------------------------------------------------------------------------------------------------------------
